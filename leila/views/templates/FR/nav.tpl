        ...
        <div class="panel with-nav-tabs panel-default">
            <div class="panel-heading">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#objects" data-toggle="tab">Objets</a></li>
                    <li><a href="#members" data-toggle="tab">Membres</a></li>
                    <li><a href="#lending" data-toggle="tab">Prêter</a></li>
                    <li class="navbar-right"><a href='login.php?logout=1'>Logout {$smarty.session.username}</a></li>
                    <li class="dropdown navbar-right">
                        <a href="#" data-toggle="dropdown">Langue <span class="caret"></span></a>
